...
let DriverConroller = require('../controller/driver.controller');

router.route('/').get(DriverConroller.findById);

router.route('/add').post(DriverConroller.add);

router.route('/delete/:id').delete(DriverConroller.Delete);

router.route('/:id').get(DriverConroller.GetId);

router.route('/update/:id').put(DriverConroller.update);

router.route('/getDriversByLocation/:location').get(DriverConroller.getDriversByLocation);
